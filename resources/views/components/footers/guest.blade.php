        ...
        <div class="row align-items-center justify-content-lg-between">
            <div class="col-12 col-md-6 my-auto">
                <div class="copyright text-center text-sm text-white text-lg-start">
                    ...
                    <a href="https://www.creative-tim.com" class="font-weight-bold text-white" target="_blank">Nulish
                        Tim</a> & <a href="https://www.updivision.com" class="font-weight-bold text-white" target="_blank">SMALLTEAM</a>
                    for a better web.
                </div>
            </div>
