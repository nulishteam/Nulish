                            ...
                            <div class="row col-12 ps-5">
                                <form method='POST' action='{{ route('answer.store') }}'>
                                    ...
                                    <div class="card-body ps-lg-0 mt-1 rounded-pill">
                                        <h4 class="mb-4 text-center rounded-3 border-bottom">Questions day!
                                            <hr>
                                        </h4>
                                    ...
                                    <div class="d-flex flex-row justify-content-start">
                                        ...
                                        <div class="col-10 mx-3">
                                            ...
                                            <div class="small  rounded-3">
                                                Menjawab pertanyaan question day.</div>
                            ...
                            <div class="card w-90 mx-5 mb-2">
                                <div class="row col-12 ps-6 mb-2">
                                    <div class="d-flex flex-row justify-content-start">
                                        ...
                                        <div class="col-10 mx-3">
                                            <div class="small me-3 d-flex fw-bold justify-content-start py-2">
                                                <a href="{{ route('profile', Auth::user()->user_key) }}">Rini handayani</a>
                                            </div>
                                            <div class="small  rounded-3">
                                                Menjawab pertanyaan question day.</div>
                                ...
                                <div class="card w-90 mx-5 mb-2">
                                    <div class="row col-12 ps-6 mb-2">
                                        <div class="d-flex flex-row justify-content-start">
                                            ...
                                            <div class="col-10 mx-3">
                                                <div class="small me-3 d-flex fw-bold justify-content-start py-2">
                                                    <a href="{{ route('profile', Auth::user()->user_key) }}">Angelia putri
                                                    </a>
                                                </div>
                                                <div class="small  rounded-3">
                                                    Menjawab pertanyaan question day.</div>
                                ...
                                <div class="card w-90 mx-5 mb-2">
                                    <div class="row col-12 ps-6 mb-2">
                                        <div class="d-flex flex-row justify-content-start">
                                            ...
                                            <div class="col-10 mx-3">
                                                <div class="small me-3 d-flex fw-bold justify-content-start py-2">
                                                    <a href="{{ route('profile', Auth::user()->user_key) }}">Dini Yuliani
                                                    </a>
                                                </div>
                                                <div class="small  rounded-3">
                                                    Menjawab pertanyaan question day.</div>
