<x-template.landing bodyClass="about-us bg-gray-200">
    ...
    <header class="bg-gradient-dark">
        <div class="page-header min-vh-90" style="background-image: url('{{ asset('assets') }}/img/bg9.jpg');">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8 text-center mx-auto my-auto">
                        ...
                        <p class="lead mb-4 text-white opacity-8">We’re constantly trying to express ourselves and
                            ...
                            @guest
                            <a type="submit" class="btn bg-white text-dark" href="{{ route('register') }}" data-bs-toggle="tooltip" data-bs-placement="left" title="Create Acount">Register</a>
                            @endguest
                            @auth
                        ...
                        <div class="d-flex justify-content-center">
                            <div class="blur mx-2 my-1 rounded"><a href="javascript:;"><i class="fa fa-facebook-square h5 text-info mx-2 my-1"></i></a></div>
                            <div class="blur mx-2 my-1 rounded"><a href="javascript:;"><i class="fa fa-instagram h5 text-primary mx-2 my-1"></i></a></div>
                            <div class="blur mx-2 my-1 rounded"><a href="javascript:;"><i class="fa fa-twitter h5 text-info mx-2 my-1"></i></a></div>
                        </div>
                    </div>
                </div>
            </div>
