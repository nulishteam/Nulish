                            ...
                            <ul class="navbar-nav ms-auto">
                                <li class="nav-item d-flex align-items-center">
                                    <a class="btn btn-info text-capitalize text-md px-3 py-2"
                                        href="javascript:window.location.replace('{{ route('faizCoba.create') }}')">
                                        ...
                                        @isset($levels)
                                            @foreach ($levels as $level)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span>
                                                            <a href="javascript:window.location.replace('{{ route('faizCoba.edit', $level) }}');"
            ...
            function confirmDelete(obj) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            type: "DELETE",
                            url: "{{ route('faizCoba.index') }}/" + obj.id,
                            data: {
                                "id": obj.id,
                                "_token": token,
                            },
                            ...
                            success: function(res) {
                                Swal.fire(
                                    ...
                                    window.location.href = "{{ route('faizCoba.index') }}";
