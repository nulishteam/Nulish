            ...
            <div class="card">
                <div class="d-flex ps-3">
                    ...
                    <ul class="nav justify-content-end px-1 ms-auto me-1">
                        <li>
                            <a class="text-danger text-lg" href="javascript:cancelEdit('{{ route('faizCoba.index') }}');">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('faizCoba.store') }}">
                        @csrf
                        ...
                        <div class="row py-2">
                            ...
                            <div class="col-12 col-md-6 col-lg-4 py-1">
                                ...
                                <div class="col-12 col-md-6 col-lg-4 py-1">
                                    <div class="form-group">
                                        <label for="chkbxCoba" class="form-label">Level Weight</label>
                                        <input type="checkbox" class="form-check-input border border-2 p-2"
                                            id="chkbxCoba" name="coba_aja">
                                    </div>
                                </div>
                            </div>
